...
class AppStyles {
  static final mainTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
        style: ButtonStyle(
      backgroundColor:
          MaterialStateProperty.all<Color>(AppColors.green_jdm_arrow),
    ...
    textTheme: TextTheme(
      headline1: TextStyle(
          color: AppColors.black, fontSize: 24, fontWeight: FontWeight.w400),
      headline2: TextStyle(
  ...
  static Border dropdownBorder = Border.fromBorderSide(BorderSide(
